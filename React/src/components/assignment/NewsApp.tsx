            ...
            <NewsContainer>
                <Container>
                    ...
                    <section>
                        <News>
                            <Col lg={4}>
                                <Img src="../../../public/assets/background/night.jpg" alt="img"></Img>
                            </Col>
